...
<head>
  ...
  <meta name="description" content="PCET's Pune Business School | Top B School in Pune | Best PGDM College in Pune" />
...
<body>
  ...
  <div class="row" id="bgImage">
    <h2 class="container content text-uppercase" style="color: rgb(157, 18, 20);">
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-9 tab-content text-justify">
            <div class="tab-pane fade " id="blog5">
              <h2 class="media-heading text-left" style="color: rgb(157, 18, 20) "> About PBS</h2>
              <p class="lead">
                <iframe width="560px" height="315px" src="https://www.youtube.com/embed/pL24su-rOn8" frameborder="0"
            ...
            <div class="tab-pane fade" id="blog1">
              <div class="col-xs-12 box">
                <div class="microsoft container1 text-justify">
                  ...
                  <h2 class="media-heading text-left" style="color: rgb(157, 18, 20) "> PBS Advantage</h2>
            ...
            <div class="tab-pane fade" id="blog2">
              <div class="col-xs-12 box">
                <div class="microsoft container1">
                  <h2 class="media-heading text-left" style="color: rgb(157, 18, 20) ">
                    Vision and Mission
                  </h2>
                  ...
                  <div class="media">
                    ...
                    <div class="media-body">
                      <p class="hidden-xs">
                        ...
                        The sacred ambience of our campus invites you to the most unique experience of quality learning
                        in
