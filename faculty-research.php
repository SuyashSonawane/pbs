   ...
   <html class="ie ie9" lang="en">
      ...
      <html lang="en">
         ...
         <head>
            ...
            <meta charset="utf-8" />
            <title>
               Pune Business School | Top Business Scholol in Pune
            </title>
            <meta
               name="description"
                           ...
                           <ul class="nav nav-tabs nav1 text-uppercase">
                              ...
                              <li>
                                 <a aria-expanded="true" data-toggle="tab" href="#blog4"
                                    >
                                    <h5>Techno Management Visiting Faculty</h5>
                                 </a>
                              </li>
                              </li>
                           </ul>
                              ...
                              <div class="tab-pane fade " id="blog1">
                                 <div class="faculties">
                                    ...
                                    <div class="panel panel-default faculty">
                                       ...
                                       <div class="panel-footer text-center">
                                          <h5 class="lead">
                                             Dr. Mitali Talukdar, Associate <br />
                                             Professor, HR & General Management
                                          </h5>
                                          <h6>
                                             Ph.D,MPM,B.Sc.,B.ED
                                          </h6>
