...
<header>
  ...
  <nav>
          ...
          <li class="drop-normal">
            ...
            <div class="drop-down-container normal">
              <ul>
                ...
                <li>
                  <a href="./about-PBS.php#2" title="PBS Advantage"
                    >PBS Advantage</a
                  >
                </li>
                <li>
    ...
    "
                ...
                <li>
                  <a href="#" title="Mandatory Disclosures"
                  ...
                  <ul class="list-menu">
                    <li>
                      <a
                        ...
                        ><i class="icon-laptop"></i> IT Infrastructure &
                        Resources</a
                      >
                    </li>
                    <li>
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  ...
                  <ul class="list-menu">
                    ...
                    <li>
                      <a href="./admission.php#2" title="Fees Structure"
                        >Fees Structure</a
                      >
                    </li>
                  </ul>
          ...
          <li>
            ...
            <div class="drop-down-container" id="icon-menu">
              <div class="row">
                ...
                <div class="col-md-3">
                  <a
                    href="./life-at-pbs.php#StudentCouncil"
                ...
                <div class="col-md-3">
                  <a
                    ...
                    ><i class="icon-group icon-3x"></i>Student Initiatives and
                    Student Clubs</a
                  >
                </div>
                <div class="col-md-3">
                  <a href="./life-at-pbs.php" title="Students Achievements"
                    ><i class="icon-envelope icon-3x"></i>Students
                    Achievements</a
                  >
                </div>
      ...
      ></iframe>
                ...
                <div class="col-md-6">
                  ...
                  <ul>
                    <li>
                      <i class="icon-home"></i> Sector No. 26, Pradhikaran
                    </li>
                    <li><i class="icon-phone"></i> Nigdi, Pune - 411 044.</li>
                    <li>
                      <i class="icon-phone-sign"></i> Tel: 020 276 597 70 /
                      89759 82140
                    </li>
                    <li>
    ...
    <h2 class="text-center">PCET at Glance</h2>
